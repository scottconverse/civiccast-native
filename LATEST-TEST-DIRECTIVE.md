...
Current: `soak/DIRECTIVE-BETA7-FINALIZE-R5-INVALIDATION-E27A91.md`

Autorun: `soak/autorun/AUTORUN-00-BETA7-FINALIZE-R5-INVALIDATION-E27A91.ps1`
...
published. This once-only recovery order performs read-only verification of
the exact R5 task, processes, channel configs/states, and owned schedule rows,
then publishes and remotely verifies only `job.json` and `INVALIDATED.json`.
