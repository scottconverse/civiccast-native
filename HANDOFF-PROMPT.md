...
AUTHORITY: the owner grants it explicitly, per action. Do NOT open pull requests, push branches,
or write to the repository on your own initiative. A PR costs a full CI cycle. Ask first, every
time.
