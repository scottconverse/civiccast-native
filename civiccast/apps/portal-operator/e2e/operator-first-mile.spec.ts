...
test.describe('operator first mile', () => {
  ...
  test('system health shows safe-to-broadcast and runs private rehearsal', async ({ page }) => {
    ...
    await page.getByRole('alertdialog').getByRole('button', { name: 'Finish, then stop' }).click()
    ...
    await page.getByRole('alertdialog').getByRole('button', { name: 'Run rehearsal' }).click()
    ...
    await page.getByRole('alertdialog').getByRole('button', { name: 'Open window' }).click()
    ...
    await page.getByRole('alertdialog').getByRole('button', { name: 'Run proof' }).click()
