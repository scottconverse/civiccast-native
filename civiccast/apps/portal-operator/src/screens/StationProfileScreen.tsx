    ...
    >
      ...
      >
        ...
        <p id="live-captions-help" className="text-xs" style={{ color: 'var(--cc-ink-2)' }}>
          When this is on, CivicCast writes captions in real time — but one channel at a time; the
          others pause while they wait their turn. It is useful, and it is hard work for this
          computer. If playout is stuttering or channels are restarting, turn it off: the picture
          and sound always come first, and
