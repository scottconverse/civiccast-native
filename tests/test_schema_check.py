...
def test_expected_head_matches_the_single_migration_head() -> None:
    ...
    # is reserved for feat/s7-media-lifecycle. 0077_media_lifecycle (S7
    ...
    assert expected_migration_head() == "0077_media_lifecycle"
...
def test_schema_check_reports_current_from_non_repo_working_directory(
    ...
    assert status == SchemaStatus(
        state="current",
        db_revision="0077_media_lifecycle",
        expected_head="0077_media_lifecycle",
    )
