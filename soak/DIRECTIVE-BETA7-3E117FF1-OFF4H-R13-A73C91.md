# Beta.7 four-hour physical soak R13
...
- Mission: `BETA7-3E117FF1-OFF4H-R13-A73C91`
- Task: `CivicCast-Beta7-3e117ff1-OFF4H-R13-A73C91`
- Package source anchor: `e54752b01a537e61315bf957f1136986719189ec`
- Package binding commit: `54acd54ded0cab93813bb55467e167e8c8f8e911`
- Harness manifest SHA-256:
  `d1ddedf06fcf874ff81351c8986b1e75f74b3f85fe3a8f5ba4f072b6ff000731`
...
`soak/autorun/AUTORUN-BETA7-3E117FF1-OFF4H-R13-A73C91.ps1`
...
R13 harness into a new mission root, creates one elevated once-only Scheduled
...
station because it required PowerShell 7 on a Windows PowerShell 5 tester. R13
...
converting a Windows path to a Git path. R13 performs literal string replacement
...
launches are disabled. R13 checks that actual property and its regression fixture
...
commit while the launcher retained its pre-adoption source-anchor object. R13
...
plan into the driver's bounded overlap replacement path. R13 loads the R5 plan
...
disabled. R13 removes that barrier and restores the earlier proven shutdown
...
output on the same live channel. R13 binds that archive by SHA-256 and corrects
...
A passing R13 run authorizes evaluation of the four-hour gate only. It does not
