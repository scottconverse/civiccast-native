# Beta.7 four-hour physical soak R9
...
- Mission: `BETA7-3E117FF1-OFF4H-R9-9DF212`
- Task: `CivicCast-Beta7-3e117ff1-OFF4H-R9-9DF212`
- Package source anchor: `43569b4de7661bb02933cf60a1393af605c6a742`
- Package binding commit: `2509b241115f7bfa9dcc63c4f58710e3c83e9366`
- Harness manifest SHA-256:
  `03fdccc568ce02485ef89f13f89fe8ea807cbe5c5800d0b1b2c89126cbccf073`
...
`soak/autorun/AUTORUN-BETA7-3E117FF1-OFF4H-R9-9DF212.ps1`
...
R9 harness into a new mission root, creates one elevated once-only Scheduled
...
station because it required PowerShell 7 on a Windows PowerShell 5 tester. R9
...
converting a Windows path to a Git path. R9 performs literal string replacement
...
launches are disabled. R9 checks that actual property and its regression fixture
...
A passing R9 run authorizes evaluation of the four-hour gate only. It does not
