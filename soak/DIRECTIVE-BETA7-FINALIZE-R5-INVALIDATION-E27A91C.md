...
- Recovery order:
  `soak/autorun/AUTORUN-00-BETA7-FINALIZE-R5-INVALIDATION-E27A91C.ps1`
- Remote job:
...
The earlier invalidation order
`AUTORUN-00-BETA7-INVALIDATE-R5-E27A91.ps1` and the failed receipt finalizers
`AUTORUN-00-BETA7-FINALIZE-R5-INVALIDATION-E27A91.ps1` and
`AUTORUN-00-BETA7-FINALIZE-R5-INVALIDATION-E27A91B.ps1` already have their
once-only `.done` markers. Preserve all three markers. This corrected receipt
finalizer has a distinct filename and marker; it exists only to recover the
failed receipt publication.
...
1. The first invalidation order and both failed receipt finalizer exact `.done`
   markers exist and are hashed into the recovery receipt.
