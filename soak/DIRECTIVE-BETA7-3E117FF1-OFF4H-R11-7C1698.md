# Beta.7 four-hour physical soak R11
...
- Mission: `BETA7-3E117FF1-OFF4H-R11-7C1698`
- Task: `CivicCast-Beta7-3e117ff1-OFF4H-R11-7C1698`
- Package source anchor: `bb1f7e5c7354a9f7b13dca2f26f0012027ed0fc8`
- Package binding commit: `38d6e565e70d15b9a866986a42339f5b249920c4`
- Harness manifest SHA-256:
  `49fb0381d224734d1392e4c67d2648d2465152c1edc0c7353ccded2635c37100`
...
`soak/autorun/AUTORUN-BETA7-3E117FF1-OFF4H-R11-7C1698.ps1`
...
R11 harness into a new mission root, creates one elevated once-only Scheduled
...
station because it required PowerShell 7 on a Windows PowerShell 5 tester. R11
...
converting a Windows path to a Git path. R11 performs literal string replacement
...
launches are disabled. R11 checks that actual property and its regression fixture
...
commit while the launcher retained its pre-adoption source-anchor object. R11
...
plan into the driver's bounded overlap replacement path. R11 loads the R5 plan
...
A passing R11 run authorizes evaluation of the four-hour gate only. It does not
