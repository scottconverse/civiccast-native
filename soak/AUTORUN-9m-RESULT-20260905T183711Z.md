# AUTORUN-9m soak #2: reschedule the approved soak assets on kit 91caebc, start, restart the soak clock
- mission: soak8-e1acfe6
- host: DESKTOP-VBMA6O5
- utc: 20260905T183711Z
...
stale state file not present (nothing to remove): C:\CivicCastSoak\state\last-egress-run
...
```json
{
    ...
    "notes":  "Soak8 AUTORUN-9m soak #2 on kit 91caebc"
}
```
...
GET /api/staff/assets?limit=200 -> 200 [{"asset_id":"soak8-9e-260905023651-ajtf","title":"Soak8 9e Asset YTDown.com_YouTube_Serving-Locally-with-Michelle-SMART-Reco_Media_lVVzrRCX9_w_001_1080p 2026-09-05 02:36:51","description":null,"meeting_body":null,"state":"validated","manifest_url":"/media/vod/soak8-9e-260905023651-ajtf/playlist.m3u8","published_at":"2026-09-05T08:51:31.359839Z","file_path":"C:\\ProgramData\\CivicCast\\data\\uploa
asset records returned: 4
asset reused: soak8-9e-260905023651-ajtf (duration_seconds=2365, state=validated, title=Soak8 9e Asset YTDown.com_YouTube_Serving-Locally-with-Michelle-SMART-Reco_Media_lVVzrRCX9_w_001_1080p 2026-09-05 02:36:51)
asset reused: soak8-9e-260905023630-zprd (duration_seconds=667, state=validated, title=Soak8 9e Asset YTDown.com_YouTube_Longmont-Weather-Report-July-23-2026-to-_Media_6yBccmsSnDc_002_360p 2026-09-05 02:36:30)
asset reused: soak8-9e-260905023627-zigy (duration_seconds=67, state=validated, title=Soak8 9e Asset YTDown.com_YouTube_Help-Upgrade-the-LPM-Podcast-Studio_Media_oiYNSJEysvs_003_360p 2026-09-05 02:36:27)
asset reused: soak8-9e-260905023612-floe (duration_seconds=67, state=validated, title=Soak8 9e Asset YTDown.com_YouTube_Help-Upgrade-the-LPM-Podcast-Studio_Media_oiYNSJEysvs_001_1080p 2026-09-05 02:36:12)
channel=public schedule_items_created=9 schedule_items_committed=9 schedule_items_commit_failed=0 schedule_items_failed=0
channel=education schedule_items_created=9 schedule_items_committed=9 schedule_items_commit_failed=0 schedule_items_failed=0
channel=government schedule_items_created=9 schedule_items_committed=9 schedule_items_commit_failed=0 schedule_items_failed=0
...
public: config_ok=True start_ok=True state=ON_AIR pid=27152 last_error=
education: config_ok=True start_ok=True state=ON_AIR pid=22396 last_error=
government: config_ok=True start_ok=True state=ON_AIR pid=41188 last_error=
observed worker processes: gst-launch-1.0=0 ffmpeg=2
soak #1 history archived to soak/archive-e502074-soak1; relaunch/pid/rollup counters reset
soak-started WRITTEN (UTC): 2026-09-05T18:40:36.1571827Z -- at least one channel confirmed ON_AIR
