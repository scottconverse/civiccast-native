...
$directiveRelative = 'soak/DIRECTIVE-BETA7-FINALIZE-R5-INVALIDATION-E27A91B.md'
$scriptRelative = 'soak/autorun/AUTORUN-00-BETA7-FINALIZE-R5-INVALIDATION-E27A91B.ps1'
...
function Publish-R5Invalidation($Verification, $DirectiveBinding) {
    ...
    $receipt = [pscustomobject][ordered]@{
        ...
        recovery_order = 'BETA7-FINALIZE-R5-INVALIDATION-E27A91B'
