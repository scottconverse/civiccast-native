...
$diagnosticRoot = 'C:\CivicCastSoak\missions\beta5-sep8-be1260bd0630\install-inventory-r1'
...
$localReport = Join-Path $diagnosticRoot 'install-inventory-r1.json'
...
$relative = "soak/beta5/$mission/install-inventory-r1.json"
