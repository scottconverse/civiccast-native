...
$diagnosticRoot = 'C:\CivicCastSoak\missions\beta5-sep8-be1260bd0630\install-inventory-r3'
...
$localReport = Join-Path $diagnosticRoot 'install-inventory-r3.json'
...
$relative = "soak/beta5/$mission/install-inventory-r3.json"
