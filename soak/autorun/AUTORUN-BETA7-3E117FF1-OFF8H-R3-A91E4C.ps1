...
$package=Join-Path $PSScriptRoot '..\beta7\3e117ff1fa9e06873ecec5b5b07f1360bc8b228d'
...
if($DryRun){
    ...
    & (Join-Path $package 'Start-Beta7PhysicalOFF8HJob.ps1') -PackageRoot $package -DryRun
