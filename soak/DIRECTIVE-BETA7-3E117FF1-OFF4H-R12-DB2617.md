# Beta.7 four-hour physical soak R12
...
- Mission: `BETA7-3E117FF1-OFF4H-R12-DB2617`
- Task: `CivicCast-Beta7-3e117ff1-OFF4H-R12-DB2617`
...
`soak/autorun/AUTORUN-BETA7-3E117FF1-OFF4H-R12-DB2617.ps1`
...
R12 harness into a new mission root, creates one elevated once-only Scheduled
...
station because it required PowerShell 7 on a Windows PowerShell 5 tester. R12
...
converting a Windows path to a Git path. R12 performs literal string replacement
...
launches are disabled. R12 checks that actual property and its regression fixture
...
commit while the launcher retained its pre-adoption source-anchor object. R12
...
plan into the driver's bounded overlap replacement path. R12 loads the R5 plan
...
disabled. R12 removes that barrier and restores the earlier proven shutdown
...
A passing R12 run authorizes evaluation of the four-hour gate only. It does not
