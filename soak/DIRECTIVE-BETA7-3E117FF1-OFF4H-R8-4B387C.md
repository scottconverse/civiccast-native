# Beta.7 four-hour physical soak R8
...
`soak/autorun/AUTORUN-BETA7-3E117FF1-OFF4H-R8-4B387C.ps1`
...
R8 harness into a new mission root, creates one elevated once-only Scheduled
...
station because it required PowerShell 7 on a Windows PowerShell 5 tester. R8
...
A passing R8 run authorizes evaluation of the four-hour gate only. It does not
