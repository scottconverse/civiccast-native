...
$sourceFiles=@('Assert-Beta7CandidateBinding.ps1','Beta7Tester.Common.ps1','AUTORUN-BETA7-FETCH-INSTALL.ps1','run-identity.json')
...
if($DryRun){Write-Output 'DRYRUN VERIFIED: exact finalized identity and upgrade plan passed; no mutation performed.';return}
