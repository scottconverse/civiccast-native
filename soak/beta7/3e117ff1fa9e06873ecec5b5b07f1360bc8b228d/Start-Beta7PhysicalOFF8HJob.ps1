...
$files=@('Assert-Beta7CandidateBinding.ps1','Beta7Tester.Common.ps1','Run-Beta7PhysicalOFF8HJob.ps1','Run-BetaExistingTesterSoakR6.ps1','Beta7TransportProbeR6.ps1','TSDuckReportClassifierR6.ps1')
...
$missionRoot='C:\CivicCastSoak\missions\beta7-3e117ff1-off8h-r3-a91e4c'
...
$outputName='physical-soak-off8h-r3-a91e4c'
...
@{order='BETA7-3E117FF1-PHYSICAL-OFF8H-R3';mission_nonce=[string]$id.mission_nonce;task_name=$taskName;launch_requested_utc=[datetime]::UtcNow.ToString('o');candidate_source_sha=[string]$id.candidate_source_sha;job_report=([string]$id.evidence_relative_root+'/job.json');status='LAUNCH_REQUESTED';measured_soak_started=$false} | ConvertTo-Json -Compress
