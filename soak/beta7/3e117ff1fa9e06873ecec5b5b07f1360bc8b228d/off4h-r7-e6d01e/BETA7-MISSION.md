...
Status: **R7 ONCE-ONLY PHYSICAL MISSION; BETA.7 REMAINS UNPUBLISHED**. R5 is
...
PowerShell 7 (`pwsh`), which is not installed on `DESKTOP-VBMA6O5`. R7 keeps
...
coordinator-only dual-runtime mode. R7 may run exactly once from its
...
- nonce: `BETA7-3E117FF1-OFF4H-R7-E6D01E`
...
back and must exactly match the published five-minute R7-owned plan. Final
