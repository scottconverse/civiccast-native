...
if([string]$id.mission_nonce -cne 'BETA7-3E117FF1-OFF4H-R9-9DF212'){throw 'Mission nonce mismatch.'}
if([string]$id.task_name -cne 'CivicCast-Beta7-3e117ff1-OFF4H-R9-9DF212'){throw 'Scheduled-task identity mismatch.'}
if([string]$id.evidence_relative_root -cne 'soak/beta7-3e117ff1fa9e06873ecec5b5b07f1360bc8b228d/physical-soak-off4h-r9-9df212'){throw 'Evidence-root identity mismatch.'}
