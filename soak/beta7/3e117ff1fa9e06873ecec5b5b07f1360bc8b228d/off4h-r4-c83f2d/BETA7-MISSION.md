...
Status: **READY FOR ISSUANCE AS ONCE-ONLY R4 RETRY**. The R3 order failed safely because the coordinator kit server was unavailable; its state and evidence remain preserved under the R3 identity.
...
- nonce: `BETA7-3E117FF1-OFF4H-R4-C83F2D`
