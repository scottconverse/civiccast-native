...
$missionRoot='C:\CivicCastSoak\missions\beta7-3e117ff1-off4h-r4-c83f2d'
...
$outputName='physical-soak-off4h-r4-c83f2d'
...
@{order='BETA7-3E117FF1-PHYSICAL-OFF4H-R4';mission_nonce=[string]$id.mission_nonce;task_name=$taskName;launch_requested_utc=[datetime]::UtcNow.ToString('o');candidate_source_sha=[string]$id.candidate_source_sha;job_report=([string]$id.evidence_relative_root+'/job.json');status='LAUNCH_REQUESTED';measured_soak_started=$false} | ConvertTo-Json -Compress
