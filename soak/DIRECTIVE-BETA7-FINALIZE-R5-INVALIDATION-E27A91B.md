...
- Recovery order:
  `soak/autorun/AUTORUN-00-BETA7-FINALIZE-R5-INVALIDATION-E27A91B.ps1`
- Remote job:
...
`AUTORUN-00-BETA7-INVALIDATE-R5-E27A91.ps1` and the first receipt finalizer
`AUTORUN-00-BETA7-FINALIZE-R5-INVALIDATION-E27A91.ps1` already have their
once-only `.done` markers. Preserve both markers. This corrected receipt
...
1. The first invalidation order and failed receipt finalizer exact `.done`
