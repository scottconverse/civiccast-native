...
Run only `soak/autorun/AUTORUN-BETA7-3E117FF1-OFF4H-R4-C83F2D.ps1`
once on `DESKTOP-VBMA6O5`. Its exact nonce is
`BETA7-3E117FF1-OFF4H-R4-C83F2D`. R3 failed safely before installation because its coordinator kit server was unavailable. Preserve the R3 completion marker, mission state, evidence root, and all earlier beta.5, beta.6, and
