...
> `v1.0.0-beta.3`, the first downloadable release) -- `setup.exe` and the
...
>
> `v1.0.0-beta.6` is the next candidate and the current owner-held
> unpublished candidate; it does not change the beta.5 install story above.
>
